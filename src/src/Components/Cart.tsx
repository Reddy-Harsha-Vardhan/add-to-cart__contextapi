...
export const Cart= () => {
  ...
  const setCart=Data[3];
    ...
    const remove = (item: { id:number; name: string; price: number; model: string; discount: number; count: number,photo:undefined | string }) => {
        let index=0;
    ...
    return (
        <div className='mt-2'>   
            ...
            <div>
                {
                    cart.map((item: { id:number; name: string; price: number; model: string; discount: number; count: number,photo:undefined | string }) => {
                        return (
